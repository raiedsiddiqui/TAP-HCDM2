...
$(document).ready(function(){
	...
	//Question 4
	if ($("#qtext:contains(Of the list of both life and health goals we just went through, can you pick 3 that you would like to focus on in the next 4 months?)").length) {
