...
<div class="content">
		...
		<h4><a href="<c:url value="/manage_clinics"/>">Clinic</a> > New Clinic</h4>
		<div class="row-fluid">		
			<h2>Clinic </h2>			
				<form id="add_clinic" action="<c:url value="/add_clinic"/>" method="POST">			
						<div class="row form-group">					
							...
							<div class="col-md-6">								
								<c:if test="${not empty sites}">
									<label>Site:</label>
								    <select name="site" id="site" form="add_clinic" class="form-control">
										<option value=""></option>
						...
						<input class="btn btn-primary" type="submit" align='right' value="Add Clinic" />
