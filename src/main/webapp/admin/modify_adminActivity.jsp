...
<head>
	...
	<title>Modify Admin Activity Log</title>
...
<body>
	...
	<div class="content">
		<form id="modifyAdminActivity" action="<c:url value="/update_adminActivity"/>" method="post">
		<div class="row-fluid">
			<div class="col-md-6">
		...
		<div class="row-fluid">
			<div class="col-md-3">	
				...
				<button id="mActivityLog" data-loading-text="Loading..." type="submit"  form="modifyAdminActivity" class="btn btn-primary">Save Changes</button>
			</div>
		</div>
